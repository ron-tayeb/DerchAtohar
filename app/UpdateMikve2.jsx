...
export default function UpdateMikve2({ navigation, route }) {
    ...
    const[mikveCode,setMikveCode] = useState();
    ...
    const AddMikve1 = async () => {
        ...
        await fetch(`${ServerApi()}/api/UpdateMikve`, {
            method: 'POST',
            ...
            .then((result) => {
                ...
                if (JSON.stringify(result) == 1) {
                    Alert.alert("כל הכבוד", "עדכון המקווה הושלם")
                    navigation.goBack();
                }
        ...
        <View style={{ backgroundColor: "#FFF", height: '100%' }}>
            <ImageBackground source={require('../assets/test.png')} resizeMode="cover" style={{
                ...
                <View style={styles.header}>
                    ...
                    <Image
                        source={require('../assets/logos/33.png')}
                        resizeMode='contain'
                        style={{
                            marginTop: 100,
                            width: '55%',
                    ...
                    <TouchableOpacity onPress={() => { userVal() }}>
                        <View style={[styles.button, { marginTop: 30, marginBottom: 80 }]} >
                            <LinearGradient
                                ...
                                <Text style={[styles.textlogin1, {}]}>          עדכן מקווה          </Text>
                            </LinearGradient >
                        </View>
                    </TouchableOpacity>
